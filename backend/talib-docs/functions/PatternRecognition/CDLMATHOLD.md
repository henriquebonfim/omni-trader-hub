...
## Overview
The Mat Hold is a bullish continuation pattern that consists of a long white candle, followed by small declining candles, then a white candle continuing the uptrend.

## Category
Pattern Recognition

## Calculation
The CDLMATHOLD function identifies mat hold patterns:

### Mat Hold Criteria
- First candle: Long white (bullish) candle
- Upside gap between first and second bodies
- Next 2-4 candles: Small falling bodies that hold within the pattern
- Final candle: White candle that closes above the high of all previous candles in pattern
