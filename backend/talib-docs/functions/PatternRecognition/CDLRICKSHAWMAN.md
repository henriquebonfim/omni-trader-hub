...
## Overview
The Rickshaw Man is a doji candle with two long shadows indicating extreme market indecision.

## Category
Pattern Recognition

## Calculation
The CDLRICKSHAWMAN function identifies rickshaw man patterns:

### Rickshaw Man Criteria
- Doji body (open ≈ close)
- Two long shadows (both upper and lower)
