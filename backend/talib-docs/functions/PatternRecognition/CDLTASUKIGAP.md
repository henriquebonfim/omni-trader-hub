...
## Overview
The Tasuki Gap is a continuation pattern where a gap is followed by a pullback candle that doesn't close the gap.

## Category
Pattern Recognition

## Calculation
The CDLTASUKIGAP function identifies tasuki gap patterns:

### Upside Tasuki Gap Criteria
- Upside gap (between bodies)
- First candle after gap: White (bullish) candlestick
- Second candle after gap: Black candle that opens within prior body but doesn't close the gap

### Downside Tasuki Gap Criteria
- Downside gap (between bodies)
- First candle after gap: Black (bearish) candlestick
- Second candle after gap: White candle that opens within prior body but doesn't close the gap
