...
## Overview
The Modified Hikkake is a variation of the Hikkake pattern with additional trend-confirming conditions before the pattern.

## Category
Pattern Recognition

## Calculation
The CDLHIKKAKEMOD function identifies modified hikkake patterns:

### Modified Hikkake Criteria
- First candle: Base candle
- Second candle: Range less than first, closes near bottom (for bullish) or top (for bearish)
- Third candle: Breaks out with confirmation
- Additional requirements for trend context before pattern formation
