...
## Overview
The Homing Pigeon is a bullish reversal pattern consisting of a long black candle followed by a smaller black candle contained within it.

## Category
Pattern Recognition

## Calculation
The CDLHOMINGPIGEON function identifies homing pigeon patterns:

### Homing Pigeon Criteria
- First candle: Long black (bearish) candle
- Second candle: Short black body completely inside previous day's body
- Pattern appears in downtrend (bullish reversal signal)
