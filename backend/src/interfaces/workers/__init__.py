...
Usage::
    ...
    celery -A src.interfaces.workers worker --loglevel=info --concurrency=2
...
celery_app = Celery(
    ...
    include=["src.interfaces.workers.tasks"],
)
...
celery_app.conf.update(
    ...
    beat_schedule={
        ...
        "generate-ai-overview-6h": {
            "task": "omnitrader.generate_ai_overview",
