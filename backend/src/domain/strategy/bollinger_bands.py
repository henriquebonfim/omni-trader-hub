...
class BollingerBandsStrategy(BaseStrategy):
    ...
    def __init__(self, config: Config):
        ...
        # Parameters
        # Use nested config from StrategyConfig.bollinger_bands
        self.bb_length = config.strategy.bollinger_bands.length
        self.bb_std = config.strategy.bollinger_bands.std
        self.rsi_length = config.strategy.bollinger_bands.rsi_length
        self.rsi_lower = config.strategy.bollinger_bands.rsi_lower
        self.rsi_upper = config.strategy.bollinger_bands.rsi_upper
