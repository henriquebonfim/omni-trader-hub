...
class CrisisManager:
    ...
    async def set_crisis_mode(self, active: bool, reason: str = "Manual override") -> None:
        """
    ...
    async def evaluate_automated_crisis(self, contagion_risk: bool, sentiment_level: float) -> bool:
        """
        ...
        if contagion_risk and sentiment_level < -0.8:
            await self.set_crisis_mode(True, "Automated contagion and negative sentiment trigger")
            return True
