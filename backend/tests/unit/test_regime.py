...
from src.domain.intelligence.regime import MarketRegime, RegimeClassifier
...
@patch("src.domain.intelligence.regime.ta.sma")
@patch("src.domain.intelligence.regime.ta.atr")
@patch("src.domain.intelligence.regime.ta.adx")
