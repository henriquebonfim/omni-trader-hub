...
## Overview
The Stalled Pattern (Deliberation) is a bearish reversal pattern showing three white candles with diminishing momentum.

## Category
Pattern Recognition

## Calculation
The CDLSTALLEDPATTERN function identifies stalled patterns:

### Stalled Pattern Criteria
- Three white candlesticks with consecutively higher closes
- First candle: Long white
- Second and third candles: Show signs of weakening (smaller bodies, longer shadows)
- Similar to Advance Block but with specific stalling characteristics
